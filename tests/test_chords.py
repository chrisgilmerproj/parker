...
class TestAllChords(unittest.TestCase):
    ...
    def test_produce_all_chords(self):
        ...
        expected = {'augmented_major_seventh': Chord('C4M7+'),
                    'augmented_minor_seventh': Chord('C4m7+'),
                    'augmented_triad': Chord('C4aug'),
                    'diminished_seventh': Chord('C4dim7'),
                    'diminished_triad': Chord('C4dim'),
                    'dominant_flat_five': Chord('C47b5'),
                    'dominant_flat_ninth': Chord('C47b9'),
                    'dominant_ninth': Chord('C49'),
                    'dominant_seventh': Chord('C4dom7'),
                    'dominant_sharp_ninth': Chord('C47#9'),
                    'dominant_sixth': Chord('C467'),
                    'dominant_thirteenth': Chord('C413'),
                    'eleventh': Chord('C411'),
                    'half_diminished_seventh': Chord('C4m7b5'),
                    'hendrix_chord': Chord('C47b12'),
                    'lydian_dominant_seventh': Chord('C47#11'),
                    'major_ninth': Chord('C4M9'),
                    'major_seventh': Chord('C4M7'),
                    'major_sixth': Chord('C4M6'),
                    'major_thirteenth': Chord('C4M13'),
                    'major_triad': Chord('C4M'),
                    'minor_eleventh': Chord('C4m11'),
                    'minor_major_seventh': Chord('C4m/M7'),
                    'minor_ninth': Chord('C4m9'),
                    'minor_seventh': Chord('C4m7'),
                    'minor_seventh_flat_five': Chord('C4m7b5'),
                    'minor_sixth': Chord('C4m6'),
                    'minor_thirteenth': Chord('C4m13'),
                    'minor_triad': Chord('C4m'),
                    'sixth_ninth': Chord('C469'),
                    'suspended_fourth_ninth': Chord('C4sus4b9'),
                    'suspended_fourth_triad': Chord('C4sus4'),
                    'suspended_second_triad': Chord('C4sus2'),
                    'suspended_seventh': Chord('C4sus47'),
                    'suspended_triad': Chord('C4sus')}
