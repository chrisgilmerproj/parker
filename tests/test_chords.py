...
class TestAllChords(unittest.TestCase):
    ...
    def test_produce_all_chords(self):
        ...
        expected = {'added_ninth': Chord('Cadd9'),
                    ...
                    'elektra': Chord('Celektra'),
                    'eleventh': Chord('C11'),
                    'farben': Chord('Cfarben'),
                    ...
                    'mystic': Chord('Cmystic'),
                    'northern_lights': Chord('Cnorthern'),
                    'ode_to_napoleon': Chord('Cnapoleon'),
                    'petrushka': Chord('Cpetrushka'),
                    'sixth_ninth': Chord('C69'),
                    'so_what': Chord('Cso_what'),
                    ...
                    'tristan': Chord('Ctristan'),
                    'viennese_trichord': Chord('Cviennese')}
